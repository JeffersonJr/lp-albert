            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto items-start">
                    ...
                    >
                        ...
                        <div className="mt-6 bg-destructive/10 rounded-lg p-3 flex items-center gap-2">
                    ...
                    <motion.div
                        ...
                        whileInView={{ opacity: 1, x: 0 }}
                        viewport={{ once: true }}
                        className="bg-background rounded-2xl p-7 border-2 border-albert-teal shadow-card relative"
                    >
                        ...
                        <div className="mt-6 bg-albert-teal-light rounded-lg p-3 flex items-center gap-2">
